                ...
                <div className="flex items-center space-x-4">
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="pl-10 pr-4 py-2 bg-slate-800 border border-slate-700 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500 w-64"
                        />
                    </div>
                            ...
                            issues.map((issue) => (
                                <tr key={issue.id} className="hover:bg-slate-800/30 transition-colors">
                                    <td className="px-6 py-4">
                                        ...
                                        <div className="text-xs text-slate-500 mt-1 uppercase">IS-{issue.id}</div>
                                    </td>
                                    <td className="px-6 py-4">
                                    ...
                                    <td className="px-6 py-4">
                                        <div className="flex items-center space-x-2">
                                            ...
                                            <span className="text-sm text-slate-300 text-sm">{issue.assignee?.fullName || "Unassigned"}</span>
                                        </div>
                                    </td>
